...
public interface LineupHistoryRepository extends JpaRepository<LineupHistory, Long>, LineupHistoryRepositoryCustom {
	...
	@Query("update LineupHistory lh set lh.isReceivedReviewRequest = true where lh.id in (:lineupHistoryIds)")
	void bulkUpdateIsReceivedReviewRequest(@Param("lineupHistoryIds") List<Long> ids);
