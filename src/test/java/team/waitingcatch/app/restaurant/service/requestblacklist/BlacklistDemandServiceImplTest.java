...
// 		List<BlacklistDemand> responses = new ArrayList<>();
// 		Restaurant restaurant = mock(Restaurant.class);
// 		User user = mock(User.class);
// 		BlacklistDemand blacklistDemand = new BlacklistDemand(restaurant, user, "hiyo");
// 		responses.add(blacklistDemand);
//
// 		when(blacklistDemandRepository.findAllByStatus(any(AcceptedStatusEnum.class))).thenReturn(responses);
// 		when(restaurant.getUser()).thenReturn(user);
//
// 		//when
// 		List<GetBlacklistDemandResponse> a = blacklistDemandService.getBlacklistDemands(pageble);
// 		//then
// 		assertEquals("hiyo", a.get(0).getDescription());
// 	}
//
// 	@Test
